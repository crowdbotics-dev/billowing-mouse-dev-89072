...
## Project Structure
    ...
    ├── billowing_mouse_dev_89072  # Django project configurations
...
1. Clone this repo and `cd billowing_mouse_dev_89072`
...
2. Clone this repo and `cd billowing_mouse_dev_89072`
